...
class BaseballGameTest {
    ...
    void getCount_Strike(String[] userNumbers, List<Ball> systemNumbers, int expect) {
    ...
    void getCount_Ball(String[] userNumbers, List<Ball> systemNumbers, int expect) {
        baseballGame = new BaseballGame(userNumbers, systemNumbers);
    ...
    void isNotOver(String[] userNumbers, List<Ball> systemNumbers, boolean expect) {
        baseballGame = new BaseballGame(userNumbers, systemNumbers);
